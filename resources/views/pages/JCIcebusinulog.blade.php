            ...
            <div class="uk-child-width-expand@s" uk-grid>
                <div class="uk-border-rounded uk-grid-item-match" style="background-color: rgba(0,0,0,0.8); padding: 20px">
                    <div class="" data-uk-scrollspy="cls: uk-animation-slide-right-medium; target: &gt; *; delay: 150">
                        <h1 class="uk-scrollspy-inview uk-animation-slide-right-medium" style="">JCI Cebu Sinulog</h1>
                        ...
                        <p class="subtitle-text uk-visible@s uk-scrollspy-inview uk-animation-slide-right-medium" style="color: white; text-align: justify">The Junior Chamber International (JCI) is a global organization of young active citizens, purposely aimed to create positive change in local communities.
                        ...
                        <a href="{{ route('donation-form1-jci-cebu-sinulog') }}" title="Donate More" class="uk-button uk-button-primary uk-border-pill uk-scrollspy-inview uk-animation-fade" data-uk-scrollspy-class="uk-animation-fade" style="">DONATE NOW</a>
                    </div>
                </div>
        ...
        <div id="forMore" class="uk-child-width-1-3@m uk-text-center uk-margin-large-top" uk-grid>
            <div><!--left-card-->
                <div class="uk-card uk-card-default uk-border-rounded" style="background: #222427; color:white; border-bottom: 4px solid #b47024;">
                    ...
                    <div class="uk-card-body" style="padding-top: 20px;padding-bottom: 30px;">
                        <p>Make future sustainable projects that adapts to an ever changing society.<br><br></p>
                    </div>
                </div><!--uk-card-->
            </div><!--left--->
            ...
            <div> <!--middle card-->
                <div class="uk-card uk-card-default  uk-border-rounded" style="background: #222427; color:white; border-bottom: 4px solid #b47024;">
                    ...
                    background-size: cover; background-position: center">
                        ...
                        <div class="uk-card-body" style="padding-top: 20px;padding-bottom: 30px;">
                            <p>Encourage more young people in participating towards JCI's future advocacy and enhance leadership skills, creating better leaders.</p>
                        </div>
                    </div><!--uk-card-->
            </div><!--mid-->
            ...
            <div> <!---right card-->
                <div class="uk-card uk-card-default uk-border-rounded" style="background: #222427; color:white; border-bottom: 4px solid #b47024;">
                    ...
                    <div class="uk-card-body" style="padding-top: 20px;padding-bottom: 30px;">
                        <p>Make future projects that create opportunities for a lot people.<br><br><br></p>
                    </div>
                </div><!--uk-card-->
            </div><!--right-->
        </div><!---formore-->
        ...
        <div class="uk-child-width-1-3@m uk-text-center uk-margin-large-top" uk-grid>
            <div><!--left-card-->
                <div class="uk-card uk-card-default uk-border-rounded" style="background: #222427; color:white;">
                    ...
                    <div class="uk-card-body">
                        <p style="text-align: justify">Estate Planning is not only for the wealthy — everybody can benefit from ensuring their assets 
            ...
            <div> <!--middle card-->
                <div class="uk-card uk-card-default uk-border-rounded" style="background: #222427; color:white;">
                    ...
                    <div class="uk-card-body">
                        <p style="text-align: justify">JCI Cebu Sinulog in partnership with Bubble.Ph will be joining the Pop District Bazaar Holiday - The Most Wonderful Time of the year this December 10 and 11, 2018.
        <br><br>Bring your used shampoo bottles and get awesome discounts on every Bubble.Ph shampoo bar purchase!<br><br><br></p>
            ...
            <div> <!---right card-->
                <div class="uk-card uk-card-default uk-border-rounded" style="background: #222427; color:white;">
                    ...
                    <div class="uk-card-body">
                        <p style="text-align: justify">This project is an indoor target shooting activity for a cause. For those who have been asking and messaging us, we are proud to announce that Give It A Shot 2 will now be happening on January 11, 2020!
